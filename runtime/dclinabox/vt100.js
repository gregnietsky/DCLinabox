...
// MGD  17-DEC-2011  kludge for embedded
var embeddedOnContextMenu = null;
...
VT100.prototype.initializeElements = function(container) {
  ...
  // MGD  10-JAN-2012  always embedded for DCLinabox
  //                   (on a standlone terminal page the above calculation is
  //                    confused by page width coinciding with terminal width)
...
VT100.prototype.cancelEvent = function(event) {
  ...
  // MGD  17-DEC-2011  kludge for embedded
  if (this.isEmbedded) {
     if (embeddedOnContextMenu == null)
        embeddedOnContextMenu = document.body.oncontextmenu;
     try { document.body.oncontextmenu = function() {return false;};} catch(e){}
     setTimeout("document.body.oncontextmenu = embeddedOnContextMenu;",500);
  }
...
// MGD  13-DEC-2011  fix for embedded
if (this.isEmbedded) {
...
VT100.prototype.about = function() {
  alert("VT100 Terminal Emulator " + "2.10 (revision 186 MGD.4)" +
...
// MGD  28-NOV-2012  patch for FF 15
...
// MGD  11-JAN-2012  implement 80/132 mode for DCLinabox
...
//  MGD  10-JAN-2012  fix for erase
var color = this.color;
if (this.attr & 0x0100) {
   var fgbg = color.split(' ');
   this.color = 'a' + fgbg[1].substr(3) + ' bgA' + fgbg[0].substr(1);
}
  switch (number) {
...
// MGD 17-DEC-2011 fix zero character, 0x2588 changed to 0x0030
